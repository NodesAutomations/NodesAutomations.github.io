...
- I've used this for Git and GitHub for a few years but am not using it anymore since [Visual Studio Community](#visual-studio-community) and [Visual Studio Code](#visual-studio-code) got built-in support for Git and GitHub
